<template>
    <b-modal id="myModal" title="Nuevo Equipo" footer-class="mymodal-footer" ref="myModal" body-class="mymodal-body">
...
export default {
    data() {
        return{
            ...
            jugadores: [
                { text: "Elige un jugador", value: null },
                "Jugador 1",
                "Jugador 2",
                "Jugador 3",
                "Jugador 4",
    ...
    methods: {
        ...
        onReset(evt){
            ...
            this.show = false;
            // Permite estar iterando sobre todos los elementos validados
            this.$nextTick(() => {
                this.show = true;
            })
        }
